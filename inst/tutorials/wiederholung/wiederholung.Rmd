...
Gib nur jene Probanden mit einer Selbstwirklichung von über 3.5 aus.
...
Ermittle das Standardabweichung beider Geschlechter in einem Befehl mit `group_by()` und nenne das Ergebnis SD
...
Angenommen, das vorherige Ergebnis ist als Variable namens `erg1` gespeichert. Füge eine neue Spalte namens `Vergleich` hinzu, in der du prüfst, ob der Mittelwert größer ist, als die Werte der Sinnerfüllung. Speicher das Ergebnis wieder in `erg1`.
...
Zähle nun die Anzahl der Personen in den verschiedenen Gruppen. Das vorherige Ergebnis sei erg2 genannt. 
