...
data(indo, package = "rBasics")
data(df, package = "rBasics")
```
...
Der Datensatz besteht aus 11 Spalten. Neben soziodemografischen Informationen wie Geschlecht, Alter und Familienstand, gibt es 8 Spalten, die verschiedene Dimensionen der Lebenszufriedenheit indonesischer Probanden erfassen. Diese setzen sich aus verschiedenen Faktoren zusammen, die im Datensatz nicht enthalten sind. 
...
Gib in absteigender Reihenfolge von Alter die Spalten Alter, Sinnkrise und Sinnerfuellung von jenen Versuchspersonen aus, die weiblich sind und einen Selbsttranzendenz Wert von unter 3 haben. desc() ordnet nach absteigender Abfolge an. 
...
### Säulendiagramm
Wähle die Spalten Geschlecht, Sinnerfuellung und Sinnkrise aus. Füge Sinnerfuellung und Sinnkrise in einer Spalte zusammen und benenne den Key mit **Zustand** und die Value mit **Auspraegung**. Achte darauf den tibble in einen Data.frame umzuwandeln.
