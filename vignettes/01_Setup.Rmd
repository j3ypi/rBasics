...
- Klicke anschließend auf das aktuellste `.pkg` (z.B. `R-3.5.1.pkg`). Falls Du eine ältere Mac Version als El Capitan (10.11) besitzt, musst Du `R-3.3.3.pkg` herunterladen. Wenn Du Deine Mac Version nicht kennst, kannst Du erst einmal das neueste ausprobieren. R wird Dir dann mitteilen, ob Dein Betriebssystem zu alt ist. 
...
```
- Folge der Installationsanweisung und gib Dein Passwort ein. Lass Dich nicht davon irritieren, dass im Terminal keine Zeichen bei der Passworteingabe angezeigt werden.
